...
def disgust():
    furhat.set_led(red=0, green=150, blue=0)
    furhat.gesture(body={
        "name": "FearExpression",
        "class": "furhatos.gestures.Gesture",
        "frames": [
...
def ask_ollama(emotion):
    ...
    system_prompt = f"L'utilisateur semble {emotion}. Réponds-lui avec empathie en français. sans poser de questions à lui et en moins de 3 phrases"
